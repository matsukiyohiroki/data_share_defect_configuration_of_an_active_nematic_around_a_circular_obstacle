...
set output "../output_pdf_files/scalar_order_parameter_active_homogeneous_positive_alpha.pdf";
...
#################################### Plot
datfile = "../data_files/scalar_order_parameter_active_homogeneous_positive_alpha.dat";

...
set output "../output_pdf_files/alpha_vs_r_d_simulation_and_theory_homeotropic.pdf";

plot \
	     "../data_files/r_d_bisection_method_homeotropic_lambda_1.5_nmax_0.txt" \
	     with lines lw 2 lc "red" dt 1 title "Theory, Up to n = 0", \
	     "../data_files/r_d_bisection_method_homeotropic_lambda_1.5_nmax_1.txt" \
	     with lines lw 2 lc "blue" dt '_' title "Theory, Up to n = 1", \
	     "../data_files/r_d_bisection_method_homeotropic_lambda_1.5_nmax_2.txt" \
	     with lines lw 2 lc "orange" dt '_-' title "Theory, Up to n = 2", \
	     "../data_files/r_d_bisection_method_homeotropic_lambda_1.5_nmax_3.txt" \
	     with lines lw 2 lc "dark-violet" dt '-.' title "Theory, Up to n = 3", \
	     "../data_files/alpha_vs_r_d_simulation_homeotropic_lambda_1.5.txt" \

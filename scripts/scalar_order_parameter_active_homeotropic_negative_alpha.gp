...
set output "../output_pdf_files/scalar_order_parameter_active_homeotropic_negative_alpha.pdf";
...
#################################### Plot
datfile = "../data_files/scalar_order_parameter_active_homeotropic_negative_alpha.dat";
